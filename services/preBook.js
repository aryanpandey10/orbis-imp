...
async function propertyPreBook(login, password, arrivalDate, duration, bookingToken, roomBookings) {
            ...
            ${roomBookings.map(room => `
              <RoomBooking>
                  ...
                  <GuestConfiguration>
                      ...
                      <ChildAges>
                          ${(room.childAges || []).map(age => `<ChildAge>${age}</ChildAge>`).join('\n')}
                      </ChildAges>
...
module.exports = propertyPreBook;
